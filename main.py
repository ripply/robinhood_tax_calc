...
from modules.tax_calc import calculate_total_fees, calculate_total_investment, calculate_dividends_interest, calculate_stock_gains_and_losses, calculate_options_gains_and_losses, normalize_splits

def process_year(cursor, tax_year):
    ...
    option_gains_and_losses = calculate_options_gains_and_losses(cursor, tax_year)
...
def main():
    ...
    normalize_splits(cursor)
    process_year(cursor, 2018)
    process_year(cursor, 2019)
    process_year(cursor, 2020)
    process_year(cursor, 2021)
    process_year(cursor, 2022)
    process_year(cursor, 2023)
